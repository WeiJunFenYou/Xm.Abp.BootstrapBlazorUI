...
using Xm.Abp.Account.Web.Pages.Account.Components.ProfileManagementGroup.Password;
using Xm.Abp.Account.Web.Pages.Account.Components.ProfileManagementGroup.PersonalInfo;
using Volo.Abp.Identity;
using Volo.Abp.Users;

namespace Xm.Abp.Account.Web.ProfileManagement;
